...
<body>
    ...
    <script>
        const gridSize = 16;
        const validWords = [
            "REVOLUÇÃO", "GLOBALIZAÇÃO", "INDUSTRIALIZAÇÃO", "URBANIZAÇÃO",
            "GUERRA", "DITADURA", "DEMOCRACIA", "COMUNISMO",
            "SOCIALISMO", "CAPITALISMO", "TERRORISMO", "LIBERALISMO"
        ];
        ...
        function checkIfAllWordsFound() {
            ...
            if (allWordsFound) {
                Swal.fire({
                    ...
                    window.location.href = 'idadecontemp_caça.php';  // Altere o link conforme necessário
                });
            }
        }
